...
private:
    ...
    int interactionPriority(int interaction) const;
    void switchAvatarFrame(int frameIndex);
    void clearPendingFrameRequest();
    ...
    void updatePointerResponse(const QPointF &position);
    void triggerSparkleBurst(bool generous = false);
    ...
    quint64 m_interactionGeneration{0};
    quint64 m_pendingFrameGeneration{0};
    quint64 m_clickGeneration{0};
    qint64 m_frameTransitionStarted{-1};
    qint64 m_lastFrameSwitchAt{-1};
    int m_frameTransitionDuration{420};
    QPoint m_dragOffset;
    ...
    QTimer *m_hoverFrameTimer{};
    QElapsedTimer m_clock;
    QElapsedTimer m_clickCycle;
    QPointF m_pointerTarget{0.5, 0.38};
    QPointF m_pointerResponse{0.5, 0.38};
    QList<QPointF> m_sparkles;
    qreal m_sparkleProgress{1.0};
    qint64 m_lastInteractionAt{-1};
    qint64 m_lastClickAt{-1};
    qint64 m_lastWheelSpecialAt{-1};
    qint64 m_lastSparkleAt{-1};
    qint64 m_lastInteractionRequest{-1};
