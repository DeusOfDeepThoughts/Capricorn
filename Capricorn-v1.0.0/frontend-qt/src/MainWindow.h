...
private:
    ...
    QWidget *buildUserProfilePage();
    QWidget *buildUserProfileSection();
    ...
    void applyUserProfileLayout(int availableWidth);
    void setupTrayIcon();
    void minimizeToTray();
    void beginFastExit();
    ...
    void updateBuildPetInteractionState();
    void updateGeneratePetAvailability();
    void showVoiceConfigDialog();
    ...
    QJsonObject buildUserProfileCandidate() const;
    QJsonObject buildUserProfileTopicsCandidate(const QString &personaId) const;
    void persistUserProfileObjective(const QJsonObject &candidate);
    void renderUserProfileSnapshot();
    void requestUserProfileUpdate();
    void scheduleUserProfileUpdate(int delayMs = 1500);
    void requestUserProfileTopicsUpdate();
    void scheduleUserProfileTopicsUpdate(int delayMs = 1500);
    void scheduleUserProfileTopicsUpdateForPersona(const QString &personaId, int delayMs = 1500);
    ...
    bool askTopmostQuestion(const QString &title, const QString &message, const QString &acceptText = QStringLiteral("是"), const QString &rejectText = QStringLiteral("否"), bool hideTitle = false);
    void setSyncStep(int index, const QString &state);
    void resetSyncSteps();
    void generatePet();
    void continueGeneratePetAfterModelVerification(const QJsonObject &config);
    bool generationPersonaStillValid(const QString &personaId, quint64 generation) const;
    ...
    void exportCurrentChatHistory();
    void importCurrentChatHistory();
    ...
    QToolButton *m_voiceSettingsButton{};
    ...
    QFrame *m_userProfileSection{};
    QGridLayout *m_userProfileGrid{};
    QGridLayout *m_profileTopicGrid{};
    QLabel *m_profileSummary{};
    QLabel *m_profileMeta{};
    QWidget *m_profileChart{};
    QVBoxLayout *m_profileBestPetLayout{};
    QVBoxLayout *m_profileWordsLayout{};
    QList<QWidget *> m_profileTopicCards;
    QWidget *m_profileTopicEmpty{};
    int m_profileTopicTopologyKey{0};
    QTimer *m_userProfileUpdateTimer{};
    bool m_userProfileDirty{false};
    bool m_userProfileLoading{false};
    quint64 m_userProfileRequestId{0};
    int m_userProfileRetryCount{0};
    QString m_userProfileRetryInputHash;
    QString m_userProfileStatus;
    QTimer *m_userProfileTopicsTimer{};
    QSet<QString> m_pendingUserProfileTopicsPersonas;
    bool m_userProfileTopicsDirty{false};
    bool m_userProfileTopicsLoading{false};
    quint64 m_userProfileTopicsRequestId{0};
    QHash<QString, int> m_userProfileTopicsRetryCounts;
    QHash<QString, QString> m_userProfileTopicsRetryInputHashes;
    QString m_userProfileTopicsActivePersonaId;
    QString m_userProfileTopicsStatus;

    QLineEdit *m_baseUrl{};
    QLineEdit *m_modelId{};
    QLineEdit *m_apiKey{};
    QCheckBox *m_modelShowApiKeyCheck{};
    QCheckBox *m_modelAutoSyncCheck{};
    ...
    quint64 m_generationRequest{0};
    QString m_generationPersonaId;
